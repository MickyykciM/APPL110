...
int phoneStandStep = 7;

void phoneStandTilt(int delta)
{
  phoneStandStep += delta;
  if (phoneStandStep < 3)  phoneStandStep = 3;
  if (phoneStandStep > 11) phoneStandStep = 11;
  AppServo.DeviceDriverSet_Servo_controls(2 , phoneStandStep);
}
